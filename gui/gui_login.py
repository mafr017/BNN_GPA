...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pbPetunjuk.setEnabled(True)
        self.pbPetunjuk.setMinimumSize(QtCore.QSize(100, 35))
        self.pbPetunjuk.setMaximumSize(QtCore.QSize(100, 35))
        self.pbPetunjuk.setAcceptDrops(True)
        self.pbPetunjuk.setToolTip("")
        self.pbPetunjuk.setToolTipDuration(0)
        self.pbPetunjuk.setStatusTip("")
        self.pbPetunjuk.setWhatsThis("")
        self.pbPetunjuk.setObjectName("pbPetunjuk")
        self.horizontalLayout_8.addWidget(self.pbPetunjuk)
