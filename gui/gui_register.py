...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.leNama_2 = QtWidgets.QLineEdit(self.frame_10)
        self.leNama_2.setMinimumSize(QtCore.QSize(200, 30))
        self.leNama_2.setMaxLength(8)
        self.leNama_2.setObjectName("leNama_2")
        self.horizontalLayout_9.addWidget(self.leNama_2)
        self.lUniqe = QtWidgets.QLabel(self.frame_10)
        self.lUniqe.setMinimumSize(QtCore.QSize(65, 0))
        self.lUniqe.setMaximumSize(QtCore.QSize(70, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lUniqe.setFont(font)
        self.lUniqe.setStyleSheet("color: rgb(255, 0, 0);")
        self.lUniqe.setText("")
        self.lUniqe.setScaledContents(True)
        self.lUniqe.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lUniqe.setWordWrap(False)
        self.lUniqe.setObjectName("lUniqe")
        self.lUniqe.setHidden(True)
        self.horizontalLayout_9.addWidget(self.lUniqe)
        ...
        self.leNama = QtWidgets.QLineEdit(self.frame_7)
        self.leNama.setMinimumSize(QtCore.QSize(200, 30))
        self.leNama.setMaxLength(40)
        self.leNama.setObjectName("leNama")
        self.horizontalLayout_6.addWidget(self.leNama)
        self.lNama = QtWidgets.QLabel(self.frame_7)
        self.lNama.setMinimumSize(QtCore.QSize(65, 0))
        self.lNama.setMaximumSize(QtCore.QSize(70, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lNama.setFont(font)
        self.lNama.setStyleSheet("color: rgb(255, 0, 0);")
        self.lNama.setScaledContents(True)
        self.lNama.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lNama.setWordWrap(False)
        self.lNama.setObjectName("lNama")
        self.lNama.setHidden(True)
        self.horizontalLayout_6.addWidget(self.lNama)
        ...
        spacerItem11 = QtWidgets.QSpacerItem(100, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        ...
        self.leEmail = QtWidgets.QLineEdit(self.frame_9)
        self.leEmail.setMinimumSize(QtCore.QSize(200, 30))
        self.leEmail.setMaxLength(30)
        self.leEmail.setObjectName("leEmail")
        self.horizontalLayout_8.addWidget(self.leEmail)
        self.lEmail = QtWidgets.QLabel(self.frame_9)
        self.lEmail.setMinimumSize(QtCore.QSize(65, 0))
        self.lEmail.setMaximumSize(QtCore.QSize(70, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lEmail.setFont(font)
        self.lEmail.setStyleSheet("color: rgb(255, 0, 0);")
        self.lEmail.setScaledContents(True)
        self.lEmail.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lEmail.setWordWrap(False)
        self.lEmail.setObjectName("lEmail")
        self.lEmail.setHidden(True)
        self.horizontalLayout_8.addWidget(self.lEmail)
        ...
        spacerItem14 = QtWidgets.QSpacerItem(100, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        ...
        self.lId = QtWidgets.QLabel(self.frame_8)
        self.lId.setMinimumSize(QtCore.QSize(65, 0))
        self.lId.setMaximumSize(QtCore.QSize(70, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lId.setFont(font)
        self.lId.setStyleSheet("color: rgb(255, 0, 0);")
        self.lId.setScaledContents(True)
        self.lId.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lId.setWordWrap(False)
        self.lId.setObjectName("lId")
        self.lId.setHidden(True)
        self.horizontalLayout_7.addWidget(self.lId)
        spacerItem16 = QtWidgets.QSpacerItem(100, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem17 = QtWidgets.QSpacerItem(100, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem19 = QtWidgets.QSpacerItem(100, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_4.addItem(spacerItem19)
        self.verticalLayout_2.addWidget(self.frame_5)
        spacerItem20 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
        ...
        self.pbRegister = QtWidgets.QPushButton(self.frame_6)
        self.pbRegister.setMinimumSize(QtCore.QSize(0, 35))
        self.pbRegister.setMaximumSize(QtCore.QSize(300, 500))
        ...
        self.horizontalLayout_5.addWidget(self.pbRegister)
        spacerItem22 = QtWidgets.QSpacerItem(100, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem24 = QtWidgets.QSpacerItem(150, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem26 = QtWidgets.QSpacerItem(666, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Registrasi Admin"))
        self.label_7.setText(_translate("MainWindow", "Uniqe Key*"))
        self.leNama_2.setPlaceholderText(_translate("MainWindow", "Masukan Uniqe Key (8 Length)"))
        self.label_4.setText(_translate("MainWindow", "Nama*"))
        self.leNama.setPlaceholderText(_translate("MainWindow", "Nama Lengkap"))
        self.lNama.setText(_translate("MainWindow", "Sudah Ada"))
        self.label_6.setText(_translate("MainWindow", "E-mail*"))
        self.leEmail.setPlaceholderText(_translate("MainWindow", "anda@email.com"))
        self.lEmail.setText(_translate("MainWindow", "Sudah Ada"))
        ...
        self.lId.setText(_translate("MainWindow", "Sudah Ada"))
